...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 4131
    answer = largest_number(([1,2,31,12,542,3,1,3], [4131,32,1], [-22]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -2
    answer = largest_negative_number([(23, 1, -104),
                             (3, 10, -11, 7, 2210,-90),
                             [1, -2, 3, 423]])
    print('Expected and actual are:', expected, answer)
    ...
    # Test 2:
    expected = -.20
    answer = largest_negative_number(([1,2,3,-34,-14], [11],
                                      [-.2,32,11,654]))
    print('Expected and actual are:', expected, answer)
    ...
    # Test 4:
    expected = None
    answer = largest_negative_number( ([1, 2, 31, 12, 542, 3, 1, 3], [4131, 32, 1],
                             [54]))
    print('Expected and actual are:', expected, answer)
